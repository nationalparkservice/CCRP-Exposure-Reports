...
CF_selected <- ifelse(nps_boundary$REGION[which(nps_boundary$UNIT_CODE == params$name)] == "Northeast", "WarmDry_HotWet", "WarmWet_HotDry")
...
Historical.Regression <- read.csv(paste0("regression-tables/", park$UNIT_CODE, "-Regression Table.csv"))
